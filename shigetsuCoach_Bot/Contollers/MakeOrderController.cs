...
namespace shigetsuCoach_Bot.Contollers
{
    class MakeOrderController
    {
        ...
        {
            var messageToSent = "Оплата на карту  5168 7451 0006 7021 mastercard - 600 рублей/200 гривен. После оплаты нажать \"я оплатил\" и дальше отправить скриншот платежа сюда.\n" +
                "После проверки скриншота и баланса на карте, я скину вам код, который вы отправляете shigetsu и всё.\n" +
                "\n" +
